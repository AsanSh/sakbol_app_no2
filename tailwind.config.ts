    ...
    extend: {
      ...
      colors: {
        ...
        health: {
          ...
          secondary: "var(--ui-color-accent-hover)",
          positive: "#22C55E",
          warning: "#F59E0B",
          danger: "#EF4444",
          bg: "var(--ui-color-canvas)",
          surface: "var(--ui-color-surface)",
          text: "var(--ui-color-foreground)",
          "text-secondary": "var(--ui-color-muted)",
          border: "var(--ui-color-border)",
        },
        emerald: {
          50: "#e8f5f3",

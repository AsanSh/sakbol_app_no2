            ...
            {!invite ? (
              <>
                <p className="text-xs text-emerald-900/75">
                  Тандаңыз: кайсы профиль бөлүшүлөт. Алтымызга 9 орундуу код жана QR пайда болот;
                  кабыл алуучу Telegram аркылуу же сайтта кодду киргизет — профиль свитчерде көрүнөт.
                </p>

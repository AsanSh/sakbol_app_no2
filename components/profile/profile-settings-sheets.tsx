  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-[#70787d]">
        Здесь настраиваются оповещения SakBol.app: напоминания, статусы расшифровки анализов и
        сервисные сообщения.
      </p>
  ...
  return (
    <div className="max-h-[65dvh] space-y-6 overflow-y-auto pr-1">
      ...
      <Section title="Хранение данных">
        <p>
          Мы храним ваши данные на защищённых серверах и принимаем все необходимые меры для обеспечения
      ...
      <Section title="AI-обработка данных">
        <p>
          <strong>SakBol.app</strong> использует AI для чат-ассистента и анализа здоровья. При
          использовании чат-ассистента ваши сообщения, данные профиля здоровья (возраст, лекарства и
          т.д.) и прикреплённые документы (PDF, анализы) могут передаваться в OpenAI (сторонний
          AI-провайдер) для генерации ответов. Мы получаем ваше явное согласие в приложении перед
          отправкой любых данных. OpenAI по договору обязан защищать ваши данные мерами,
          эквивалентными нашим.
        </p>
      </Section>
      ...
      <Section title="Изменения в политике конфиденциальности">
        <p>
          Мы можем обновлять нашу Политику конфиденциальности время от времени. Мы уведомим вас о
          любых изменениях, разместив новую Политику конфиденциальности на этой странице и обновив дату
          «Последнее обновление» в верхней части этой Политики конфиденциальности.
        </p>
      </Section>
      ...
      <Section title="1. Принятие условий">
        <p>
          Используя приложение SakBol.app, вы соглашаетесь соблюдать настоящие Условия использования.
      ...
      <Section title="4. Интеллектуальная собственность">
        <p>
          Приложение SakBol.app и его оригинальный контент, функции и функциональность являются и
          останутся исключительной собственностью правообладателя SakBol.app и его лицензиаров.
      ...
      <Section title="5. Ограничение ответственности">
        <p>
          SakBol.app не несёт ответственности за любые прямые, косвенные, случайные, особые или
      ...
      <Section title="7. Медицинская информация">
        <p>
          Информация, предоставляемая в приложении SakBol.app, предназначена только для

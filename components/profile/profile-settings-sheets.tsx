  ...
  return (
    <div className="max-h-[65dvh] space-y-6 overflow-y-auto pr-1">
      ...
      <Section title="AI-обработка данных">
        <p>
          <strong>SakBol</strong> использует AI для чат-ассистента и анализа здоровья. При использовании
          чат-ассистента ваши сообщения, данные профиля здоровья (возраст, лекарства и т.д.) и
          прикреплённые документы (PDF, анализы) могут передаваться в OpenAI (сторонний AI-провайдер)
          для генерации ответов. Мы получаем ваше явное согласие в приложении перед отправкой любых
          данных. OpenAI по договору обязан защищать ваши данные мерами, эквивалентными нашим.
        </p>
      </Section>

...
const ru: Dict = {
  ...
  "analyses.emptySecondary": "Бул профиль үчүн тизме бош — төмөнкү баскыч менен жүктөңүз.",
...
const kg: Dict = {
  ...
  "analyses.emptySecondary": "Для этого профиля список пуст — загрузите бланк кнопкой ниже.",

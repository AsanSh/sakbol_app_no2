      ...
      <div className="mx-auto max-w-2xl space-y-4 px-4 pb-8 pt-2">
        ...
        {segment === "search" ? (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
            ...
            {!pharmacy ? (
              <div className="relative overflow-hidden rounded-2xl border-2 border-amber-400/90 bg-gradient-to-br from-amber-50 via-white to-teal-50/50 p-4 shadow-lg shadow-amber-900/10 ring-2 ring-amber-200/70">
                <span className="absolute right-3 top-3 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 px-2.5 py-1 text-[10px] font-extrabold uppercase tracking-wide text-white shadow-sm">
                  {t(lang, "pharmacy.registerBadge")}
                </span>
                <div className="pr-24">
                  <p className="flex items-center gap-2 font-manrope text-base font-extrabold text-amber-950">
                    <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-amber-500 text-white shadow-md shadow-amber-600/30">
                      <Plus className="h-5 w-5" strokeWidth={2.5} aria-hidden />
                    </span>
                    {t(lang, "pharmacy.registerPharmacy")}
                  </p>
                  <p className="mt-2 text-[11px] leading-snug text-amber-950/80">
                    {t(lang, "pharmacy.registerCardSubtitle")}
                  </p>
                </div>
                <input
                  value={regName}
                  ...
                  className="mt-3 w-full rounded-xl border border-amber-200/80 bg-white/95 px-3 py-2.5 text-sm shadow-sm"
                />
                <input
                  value={regAddress}
                  onChange={(e) => setRegAddress(e.target.value)}
                  placeholder={t(lang, "pharmacy.phAddress")}
                  className="mt-2 w-full rounded-xl border border-amber-200/80 bg-white/95 px-3 py-2.5 text-sm shadow-sm"
                />
                <input
                  value={regCity}
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-xl border border-amber-200/80 bg-white/95 px-3 py-2.5 text-sm shadow-sm"
                />
                <p className="mt-3 text-[11px] font-bold text-amber-950">{t(lang, "pharmacy.hoursSection")}</p>
                <label className="mt-2 flex cursor-pointer items-center gap-2 rounded-xl border border-amber-200/60 bg-white/90 px-3 py-2.5 text-sm font-semibold text-amber-950">
                  <input
                    type="checkbox"
                    checked={regHours24}
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-xl bg-gradient-to-r from-amber-600 to-orange-600 py-3 text-sm font-bold text-white shadow-md shadow-amber-900/25 disabled:opacity-50"
                >
